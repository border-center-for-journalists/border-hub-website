...
import { NoticeSection, SocialContainer } from "./index.styled"
    ...
    return (
      <NoticeSection>
        ...
        <SocialContainer className={isSticky ? "sideSticky" : ""}>
          ...
          <LinkedinShareButton
            url={this.props.url}
            title={this.props.notice.data.title.text}
          >
            <a className="icon-linkedin iconSvg">
          ...
          <WhatsappShareButton url={this.props.url}>
            <a className="icon-whatsapp iconSvg">
              <svg viewBox="0 0 64 64" width="30" height="30">
                <g>
